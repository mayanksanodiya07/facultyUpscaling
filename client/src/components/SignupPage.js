...
function SignupPage() {
  const [email, setEmail] = useState("mayursanodiyanormal@gmail.com");
    ...
    <>
      {loading && (
        <div className="absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center z-10">
          <Spinner animation="border" variant="danger" className="h-14 w-14" />
        </div>
      )}
      <div
        className={`mx-auto mt-36 mb-20 w-80 px-4 py-4 border-2 rounded-3xl flex flex-col items-center ${
